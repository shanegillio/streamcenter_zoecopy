...
enum SportLeague: String, CaseIterable, Identifiable, Codable, Hashable {
  ...
  var sfSymbol: String {
    ...
    case .soccer, .premierLeague, .laLiga, .serieA, .bundesliga: return "soccerball"
  ...
  var accentColor: Color {
    ...
    case .soccer, .premierLeague, .laLiga, .serieA, .bundesliga: return Color(red: 0.15, green: 0.65, blue: 0.30)
